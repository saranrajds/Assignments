...
public class ScheduleView {
	...
	public void getTrainInputFromUser(String trarinId) {
	...
	public void displayTrainInfo(ArrayList<Train> trains) {
		...
		System.out.println("\nTrain Number \t Name + Departure Time \t Arrival Time \t Fare ");
				
		for (Train train : trains) {

			System.out.println(train.getNumber() + "\t" + train.getName() + "\t" + train.getDepartureTime() + "\t"
